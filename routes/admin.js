...
const dashboardController = require('../contorller/admin/dashboardController')
...
router.get('/orders',admin.checkSession,adminController.order)
...
router.get('/offer',admin.checkSession,offerController.offer)
...
router.get('/coupons',admin.checkSession,couponController.coupon);
...
router.get('/sales-report',admin.checkSession,salesCotroller.salesReport)
...
router.get('/dashboard-data',dashboardController.dashboardData)
